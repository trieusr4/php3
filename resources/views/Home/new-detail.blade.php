...
<link rel="stylesheet" href="https://cdn.jsdelivr.net/npm/bootstrap@4.3.1/dist/css/bootstrap.min.css"
    ...
    <div class="header-image-wrapper">
        ...
        <div class="header-image-content">
            <h1 class="title">Chi tiết {{$new->title}} </h1>
            <p class="desc"></p> 
        </div>
    </div>  
    <div class="px-3">  
        <div class="theme-container">  
            <div class="mdc-card mt-5 p-5"> 
                <div class="row agent-wrapper">
                    ...
                    <div class="col-xs-12 col-sm-6 col-md-4 p-3">
                        <h2 class="fw-600">Tên dự án:{{$new->title}}</h2>
                        ...
                        <p class="mt-3 text-muted ">Mô tả:{{$new->des}}</p>    
                        {{-- <p class="row middle-xs"><i class="material-icons primary-color" title="Organization">business</i><span class="mx-2 text-muted fw-500">Số phòng ngủ: {{$new->bedroom}}</span></p>
                        <p class="row middle-xs"><i class="material-icons primary-color"></i><span class="mx-2 text-muted fw-500">Trạng thái: {{$new->status}}</span></p>
