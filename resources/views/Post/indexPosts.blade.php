                ...
                <div class="swiper-wrapper h-100">  
                    ...
                    <div class="swiper-slide">
                        ...
                        <div class="slide-item swiper-lazy" data-background="assets/images/props/house-1/5-big.jpg">
                            ...
                            <span class="d-none" data-slide-title="{{$item->ten_du_an}}"></span>
                            <span class="d-none" data-slide-location={{$item->dia_chi}}></span>
                            <span class="d-none" data-slide-price="{{$item->so_tang}}"></span> 
                            @endforeach
                        </div> 
                ...
                <div class="col-xs-12 col-sm-6 col-md-4 col-lg-3 p-3">
                    <div class="mdc-card o-hidden">
                        {{-- <a href="{{route('route_BackEnd_project_font_detailProject_font',['id'=>$item->id])}}">
                            <img  style="width:380px; height=237px"src="{{ $item->images?''.Storage::url($item->images):'imagesProject/1669919614_a-tb-nha-pho-dongnai-pic-Phuoc-5634-1765-1646535597.jpg' }}" class="d-block mw-100">
                        </a> --}}
                        <a href="">
